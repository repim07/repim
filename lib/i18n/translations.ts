...
const FR = {
  ...
  hero: {
    badge: "L'immobilier digital de reference en Afrique",
    h1: 'Vos recherches immobilieres',
    h1b: 'enfin simplifiees.',
    h1c: 'Donnez vie a vos projets.',
    subtitle: "REPIM digitalise l'ensemble du parcours immobilier — de la recherche a la signature. Annonces fiables, matching automatique, visites virtuelles et transactions securisees.",
    tagline: 'Securite · Impact · Simplicite',
    placeholder: 'Ville, quartier, commune...',
    searchBtn: 'Rechercher',
    check1: 'Annonces verifiees', check2: 'Mises en relation securisees', check3: 'Disponible sur Android / iOS / Web',
    ctaAndroid: 'Android & iOS', ctaWeb: 'Web App',
    available: 'Disponible sur REPIM · Abidjan',
    noFraud: 'Zero tolerance arnaque', quickReport: 'Signalement rapide', userRating: 'Note utilisateurs',
    stats: [
  ...
  propertyTypes: {
    ...
    items: [
      ...
      { label: "Opportunites d'Affaires", description: 'Decapage, bornage, viabilisation, lotissement' },
      { label: 'Gestions Immobilieres',   description: 'Suivi complet de vos biens' },
      { label: 'Renovations',             description: 'Mise en relation avec les professionnels' },
      { label: 'Architecture & Deco',     description: "Architectes, decorateurs, design d'interieur" },
    ],
  },
  features: {
    badge: 'Fonctionnalites intelligentes',
    h2a: 'Tout ce dont vous avez besoin,', h2b: 'au meme endroit',
    subtitle: 'REPIM reunit les meilleurs outils pour simplifier chaque etape de votre projet immobilier en Afrique.',
    items: [
      { title: 'Matching automatique',    desc: "Notre algorithme analyse vos criteres et vous propose en temps reel les biens qui correspondent exactement a votre profil et a votre budget." },
      { title: 'Visites virtuelles',      desc: "Visitez des biens a distance depuis votre telephone ou ordinateur. Economisez du temps et filtrez vos choix avant de vous deplacer." },
      { title: 'Chat integre',            desc: "Echangez directement avec les proprietaires, gerants ou agents depuis l'application. Rapide, securise et sans intermediaire inutile." },
      { title: 'Notifications ciblees',   desc: "Soyez alerte des qu'un bien correspondant a votre recherche est publie. Ne manquez plus jamais une opportunite immobiliere." },
    ],
  },
  howItWorks: {
    badge: 'En 3 etapes', h2: 'Comment ca marche ?',
    subtitle: 'De la recherche a la signature, REPIM vous accompagne a chaque etape de votre projet immobilier.',
    cta: 'Commencer gratuitement',
    steps: [
      { title: 'Recherchez', desc: "Definissez vos criteres : ville, quartier, budget, surface, standing. Parcourez des milliers d'annonces verifiees, avec photos et localisation sur carte." },
      { title: 'Visitez',    desc: "Planifiez une visite physique ou virtuelle directement via l'app. Chattez avec le proprietaire ou l'agent, posez vos questions en temps reel." },
      { title: 'Concretisez', desc: "Finalisez votre transaction en toute securite. Documents verifies, contrat de bail ou de vente, enregistrement automatique chez le notaire." },
    ],
  },
  testimonials: {
    badge: 'Temoignages', h2: 'Ils ont trouve avec REPIM',
    subtitle: "Des milliers d'utilisateurs font confiance a REPIM pour leurs projets immobiliers.",
    items: [
      { name: 'Amina K.',  role: 'Locataire — Abidjan',      avatar: 'AK', rating: 5, text: "REPIM m'a permis de trouver mon appartement en moins de 3 semaines. Le matching automatique m'a envoye exactement ce que je cherchais sans perdre de temps." },
      { name: 'Moussa D.', role: 'Investisseur immobilier',   avatar: 'MD', rating: 5, text: "J'ai gere deux transactions depuis la diaspora grace aux visites virtuelles. La transparence et la securite de REPIM m'ont vraiment rassure." },
      { name: 'Sophie L.', role: 'Proprietaire vendeur',      avatar: 'SL', rating: 5, text: "J'ai publie mon bien et recu des demandes qualifiees le lendemain. Le tableau de bord pour gerer mes annonces est vraiment intuitif." },
      { name: 'Yves K.',   role: 'PRO Agence — Cocody',      avatar: 'YK', rating: 5, text: "En tant qu'agence certifiee REPIM, j'ai triple mon volume de contacts en 2 mois. La plateforme attire des clients serieux et bien informes." },
    ],
  },
  pricing: {
    badge: 'Tarifs professionnels', h2: 'Un acces premium, sans mauvaise surprise',
    subtitle: "Gratuit pour les locataires et acheteurs · Abonnement pour les professionnels et proprietaires",
  ...
  faq: {
    badge: 'Questions frequentes', h2: 'Foire aux Questions',
    subtitle: 'Tout ce que vous devez savoir sur REPIM.',
    noAnswer: 'Vous ne trouvez pas votre reponse ?', contactTeam: 'Contactez notre equipe',
    items: [
      { q: 'REPIM est-il gratuit pour les chercheurs ?',             a: "Oui, la navigation, la recherche et la consultation des annonces sont totalement gratuites pour les locataires et acheteurs. Seuls les professionnels souscrivent a un abonnement pour publier." },
      { q: 'Comment fonctionne la verification des annonces ?',      a: "Chaque annonce est soumise a une verification manuelle avant publication. Les professionnels doivent fournir un dossier KYC complet (pieces d'identite, agrement MCLU). Cela garantit zero arnaque." },
      { q: 'Puis-je visiter un bien a distance ?',                   a: "Absolument. REPIM propose des visites virtuelles integrees pour la plupart des biens. Vous pouvez aussi planifier une visite physique directement depuis la fiche du bien." },
      { q: 'Combien de temps dure la validation de mon dossier KYC ?', a: "La validation prend generalement entre 24 et 48 heures ouvrables. Vous recevez une notification par email et dans votre tableau de bord des que votre dossier est traite." },
      { q: "Comment contacter le proprietaire ou l'agent d'un bien ?", a: "Depuis la fiche d'un bien, vous pouvez envoyer un message via le chat integre, appeler directement ou demander une visite. Toutes les communications sont tracees pour votre securite." },
      { q: "Est-ce que REPIM est disponible en dehors de Cote d'Ivoire ?", a: "REPIM est concentre sur la Cote d'Ivoire, mais accessible partout dans le monde. La diaspora ivoirienne peut rechercher, favoriser et contacter des vendeurs sans se deplacer." },
      { q: 'Comment utiliser un code promo ?',                       a: "Lors de la souscription, entrez votre code promo dans le champ dedie avant de valider le paiement. La reduction s'applique immediatement. Les codes sont valables une seule fois." },
      { q: "Puis-je changer mon abonnement en cours de periode ?",   a: "Oui, vous pouvez passer a un plan superieur a tout moment depuis votre tableau de bord. La difference de montant est proratisee. Le passage a un plan inferieur prend effet a l'echeance." },
    ],
  },
  events: {
    badge: 'Webinaires & Salons', h2: 'Evenements a venir',
    subtitle: "Rencontrez nos experts, participez aux salons et decouvrez les opportunites immobilieres en Cote d'Ivoire.",
    register: "S'inscrire",
    items: [
      { date: '15 Juin 2026',   type: 'Webinaire', typeCls: 'bg-blue-100 text-blue-700',   title: "Investir dans l'immobilier ivoirien depuis la diaspora",    desc: "Conseils pratiques, financement, pieges a eviter — avec un expert REPIM et un notaire invite.", seats: 'Places limitees',      link: '#' },
      { date: '28 Juin 2026',   type: 'Salon',     typeCls: 'bg-green-100 text-green-700',  title: 'Salon REPIM Abidjan 2026 — Edition Speciale',               desc: 'Rencontrez plus de 50 agences et promoteurs certifies en un seul lieu. Entree gratuite sur inscription.', seats: 'Inscription gratuite', link: '#' },
      { date: '10 Juil. 2026',  type: 'Atelier',   typeCls: 'bg-orange-100 text-orange-700', title: 'Comprendre le dossier KYC : guide pas a pas',              desc: "Session pratique pour les nouveaux professionnels : comment preparer et deposer votre dossier en 30 minutes.", seats: '20 participants max', link: '#' },
    ],
  },
  promo: {
    badge: 'Code promotionnel', h2: 'Vous avez un code promo ?',
    subtitle: "Entrez votre code pour beneficier d'une reduction exclusive sur votre abonnement REPIM PRO. Valable sur tous les plans.",
    placeholder: 'Ex : REPIM2026', apply: 'Appliquer',
    ok: 'Code valide ! Reduction appliquee a la souscription.',
    err: 'Code invalide ou expire. Veuillez reessayer.',
  },
  newsletter: {
    badge: 'Newsletter immobiliere', h2: 'Restez informes des nouvelles opportunites',
    subtitle: 'Recevez chaque semaine les meilleures annonces, les actualites du marche ivoirien et les invitations a nos evenements.',
    placeholder: 'votre@email.com', btn: "S'abonner",
    success: 'Merci ! Vous recevrez notre prochaine newsletter.',
    privacy: 'Pas de spam. Desinscription en un clic. Donnees protegees.',
  },
  contact: {
    badge: 'Contact', h2: 'Parlons de votre projet',
    subtitle: "Une question sur la plateforme, un partenariat, une assistance technique ? Notre equipe vous repond sous 24h.",
    name: 'Votre nom', email: 'Email', message: 'Message',
    namePh: 'Jean Konan', emailPh: 'votre@email.com', messagePh: 'Decrivez votre demande...',
    send: 'Envoyer le message', sending: 'Envoi en cours...',
    sent: 'Message envoye !', sentSub: 'Notre equipe vous repondra dans les 24 heures.',
    again: 'Envoyer un autre message',
    phoneLabel: 'Telephone', emailLabel: 'Email', addressLabel: 'Adresse',
    address: 'Abidjan, Cote d\'Ivoire', worldwide: 'Accessible partout dans le monde',
  },
  finalCta: {
    badge: 'Securite · Impact · Simplicite',
    h2: 'Votre prochain chez-vous', h2b: 'commence ici.',
    subtitle: "Rejoignez des milliers d'utilisateurs qui font confiance a REPIM pour leurs projets immobiliers. Transparence, rapidite et securite dans un secteur en pleine transformation.",
    cta1: 'Trouver mon bien', cta2: 'Publier une annonce',
    tagline: 'Securite · Impact · Simplicite · Disponible sur Android, iOS & Web',
  },
  footer: {
    tagline: "La marketplace immobiliere qui digitalise le parcours immobilier en Afrique — de la recherche a la signature.",
    tagline2: 'Securite · Impact · Simplicite',
    copyright: `© ${new Date().getFullYear()} REPIM. Tous droits reserves.`,
    made: "Fait avec ♥ pour l'immobilier africain",
    available: "Disponible en Cote d'Ivoire et en Afrique",
    sections: [
      ...
      { title: 'Aide',       links: [{ label: 'Comment ca marche', href: '#comment-ca-marche' }, { label: 'FAQ', href: '#faq' }, { label: 'Contact', href: '#contact' }, { label: 'Blog immobilier', href: '#' }] },
      { title: 'Legal',      links: [{ label: 'CGU', href: '/conditions-generales' }, { label: 'Confidentialite', href: '/politique-de-confidentialite' }, { label: 'Mentions legales', href: '/mentions-legales' }] },
    ],
  },
}
